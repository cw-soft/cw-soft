Keks - Richtlinien     
            ...
            var odoo = {
                csrf_token: "61746a4714fe17bc3070b2c6ca57bda96fef4c36o1821523635",
                debug: "",
            };
...
},
{
  ...
  [Zum Inhalt springen](https://www.cw-softpos.de/cookie-policy#wrap)   [ ![cw-softpos.de](https://www.cw-softpos.de/web/image/website/1/logo/cw-softpos.de?unique=765cade) ](https://www.cw-softpos.de/)- [ Startseite ](https://www.cw-softpos.de/)
- [ Das Konzept ](https://www.cw-softpos.de/das-konzept)
- [ Branchen ](https://www.cw-softpos.de/cookie-policy) #### handel/Retail![Einzelhandelskasse](https://www.cw-softpos.de/web/image/1318-bb737c7b/handel.webp?access_token=9e1a73c6-cc04-47a6-94df-202f7cde61c0)
...
- [ Das Konzept ](https://www.cw-softpos.de/das-konzept)
- [ Branchen ](https://www.cw-softpos.de/cookie-policy)
- [ Konfigurator ](https://www.cw-softpos.de/konfigurator2)
- [ FAQ ](https://www.cw-softpos.de/faq)
- [ Kontakt ](https://www.cw-softpos.de/kontakt)
- [ AGB ](https://www.cw-softpos.de/allgemeine-geschaftsbedingungen)
...
------------------
 ...
 Hier finden Sie eine Übersicht über die Cookies, die auf Ihrem Gerät gespeichert werden können, wenn Sie unsere Website besuchen:
    ...
    Kategorie des Cookies Zweck Beispiele     Sitzung &amp; Sicherheit
(essenziell)
...
Ihr Erlebnis kann beeinträchtigt werden, wenn Sie diese Cookies ablehnen, aber die Website funktioniert weiterhin.
   ...
   frontend\_lang (Odoo)    Interaktionsverlauf
(optional)  Dient zur Erfassung von Informationen über Ihre Interaktionen mit der Website, die von Ihnen besuchten Seiten, und spezifische Marketingkampagnen, die Sie auf die Website geführt haben.
...
Wir können Ihnen möglicherweise nicht den besten Service bieten, wenn Sie diese Cookies ablehnen, aber die Website wird funktionieren.
   ...
   im\_livechat\_previous\_operator (Odoo)
 utm\_campaign (Odoo)
 utm\_source (Odoo)
 utm\_medium (Odoo)    Werbung &amp; Marketing
(optional)
...
Beachten Sie, dass einige Drittanbieter-Dienste zusätzliche Cookies auf Ihrem Browser installieren können, um Sie zu identifizieren.
 ...
 Sie können die Verwendung von Cookies durch Dritte verweigern und zwar auf der [Verweigerungsseite der Netzwerkwerbeinitiative](https://optout.networkadvertising.org/?c=1). Die Website funktioniert auch dann, wenn Sie diese Cookies ablehnen oder verwerfen.

   \_\_gads (Google)
 \_\_gac (Google)    Analytics
(optional)

   Verstehen Sie, wie Besucher unsere Website nutzen, mit Google Analytics. Erfahren Sie mehr über [Analytics-Cookies und Informationen zum Datenschutz.](https://support.google.com/analytics/answer/11397207?hl=en)
...
10117 Berlin
 ...
 [Nur essentielle](https://www.cw-softpos.de/cookie-policy) [Ich stimme zu](https://www.cw-softpos.de/cookie-policy) 
