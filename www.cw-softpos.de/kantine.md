Kassensystem für Kantinen     
            ...
            var odoo = {
                csrf_token: "67322606a8941ab700f4ce82f8be453d224004c5o1821523620",
                debug: "",
            };
...
},
{
  ...
  [Zum Inhalt springen](https://www.cw-softpos.de/kantine#wrap)   [ ![cw-softpos.de](https://www.cw-softpos.de/web/image/website/1/logo/cw-softpos.de?unique=765cade) ](https://www.cw-softpos.de/)- [ Startseite ](https://www.cw-softpos.de/)
- [ Das Konzept ](https://www.cw-softpos.de/das-konzept)
- [ Branchen ](https://www.cw-softpos.de/kantine) #### handel/Retail![Einzelhandelskasse](https://www.cw-softpos.de/web/image/1318-bb737c7b/handel.webp?access_token=9e1a73c6-cc04-47a6-94df-202f7cde61c0)
...
- [ Das Konzept ](https://www.cw-softpos.de/das-konzept)
- [ Branchen ](https://www.cw-softpos.de/kantine)
- [ Konfigurator ](https://www.cw-softpos.de/konfigurator2)
- [ FAQ ](https://www.cw-softpos.de/faq)
- [ Kontakt ](https://www.cw-softpos.de/kontakt)
- [ AGB ](https://www.cw-softpos.de/allgemeine-geschaftsbedingungen)
...
**Schnelle Bedienung der Gäste innerhalb kürzester Zeit**

CW-Soft**POS** Kassensysteme sind bekannt für ihre Benutzerfreundlichkeit. Mit dem ansprechenden Design und der intuitiven Benutzeroberfläche, die eine kurze Einarbeitungszeit ermöglicht, kannst du sofort loslegen.
...
Unser Gerät verbindet die funktionelle mit der optischen Komponente. Somit sorgt es für ein **ordentliches Erscheinungsbild am Kassenbereich** sowie vereinfachte Arbeitsabläufe.
 ...
 ### Das perfekte Kassensystem für Kantine

 



Die Gastronomiebranche hat spezielle Anforderungen an ihre Arbeitsprozesse und benötigt daher auch besondere Funktionen in ihrer Software wie **Tisch-Splitting** und **Gangfolgen-Bonieren**. Der **genaue Tischplan** ermöglicht es, freie Tische schnell zu identifizieren und verschiedene Bereiche wie Bar und Restaurant zu organisieren. Die Software hilft auch bei einem schnellen **Tischwechsel**, um die Gäste zufrieden zu stellen und den Betrieb reibungslos laufen zu lassen.

 

 Unsere Gastronomie - Kassensysteme im Überblick
===============================================
...
- 10.1″ Kundendisplay – HD
- Performance Thermodrucker (80mm mit Cutter) im Standfuß integriert
- Integrierte Waagenfunktion: 40g – 6/15kg
- Geeichte und zertifizierte Schnittstelle zu CW-Soft**POS** Kassensystem
...
- Integrierte Kartenzahlung per NFC
...
10117 Berlin
 ...
 [Nur essentielle](https://www.cw-softpos.de/kantine) [Ich stimme zu](https://www.cw-softpos.de/kantine) 
